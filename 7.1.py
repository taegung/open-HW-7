...
if __name__ == "__main__" :
    ...
    photo1 = PhotoImage(file = "C:/Users/82109/Desktop/강아지.gif")
    photo2 = PhotoImage(file = "C:/Users/82109/Desktop/고양이.gif")
    photo3 = PhotoImage(file = "C:/Users/82109/Desktop/토끼.gif")

    labelImage = Label(window, width = 200, height = 200, bg = "white",
                       image = None)
